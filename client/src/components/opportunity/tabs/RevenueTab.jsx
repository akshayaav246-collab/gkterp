                            ...
                            <div>
                                ...
                                {isEditing ? (
                                    <input
                                        ...
                                        className="w-full border p-2 rounded text-sm bg-gray-50 border-gray-200 focus:ring-2 focus:ring-primary-blue"
                                ...
                                <div className="flex items-center justify-between bg-gray-50 p-2 rounded border border-gray-100 min-h-[38px]">
                                    {opportunity.poDocument ? (
                                        <a
                                            ...
                                            className="text-blue-600 hover:underline text-xs flex items-center font-medium truncate max-w-[100px]"
                                            title="View Document"
                                        >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                {isEditing && !isSales ? (
                                    ...
                                    <div className={`text-sm font-medium p-2 rounded border min-h-[38px] flex items-center ${isSales ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-gray-50 text-gray-800 border-gray-100'}`}>
                                ...
                                <div className="bg-gray-50 p-2 rounded border border-gray-100 flex items-center justify-between min-h-[38px]">
                                    {opportunity.invoiceDocument ? (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="text-green-600 hover:underline text-xs flex items-center font-bold truncate max-w-[100px]"
                                            title="View Document"
                                        >
                                            <CheckCircle size={14} className="mr-1 flex-shrink-0" /> View
                                        </a>
